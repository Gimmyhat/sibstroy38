...
(function () {
  ...
  const BLUEPRINTS = [
    { src: 'img/process/process-02.jpg', label: 'АР · визуализация (3D)' },
    { src: 'img/process/process-10.jpg', label: 'АР · фасад' },
    { src: 'img/process/process-20.jpg', label: 'АР · фасад В-А, отметки' },
    { src: 'img/process/process-01.jpg', label: 'АР · кладочный план несущих стен' },
    { src: 'img/process/process-05.jpg', label: 'АР · кладочный план перегородок' },
    { src: 'img/process/process-15.jpg', label: 'АР · ведомость окон и дверей' },
    { src: 'img/process/process-03.jpg', label: 'АР · лист 03' },
    { src: 'img/process/process-04.jpg', label: 'АР · лист 04' },
    { src: 'img/process/process-06.jpg', label: 'АР · лист 06' },
    { src: 'img/process/process-07.jpg', label: 'АР · лист 07' },
    { src: 'img/process/process-08.jpg', label: 'АР · лист 08' },
    { src: 'img/process/process-09.jpg', label: 'АР · лист 09' },
    { src: 'img/process/process-11.jpg', label: 'АР · лист 11' },
    { src: 'img/process/process-12.jpg', label: 'АР · лист 12' },
    { src: 'img/process/process-13.jpg', label: 'АР · лист 13' },
    { src: 'img/process/process-14.jpg', label: 'АР · лист 14' },
    { src: 'img/process/process-16.jpg', label: 'АР · лист 16' },
    { src: 'img/process/process-17.jpg', label: 'АР · лист 17' },
    { src: 'img/process/process-18.jpg', label: 'АР · лист 18' },
    { src: 'img/process/process-19.jpg', label: 'АР · лист 19' },
  ];
